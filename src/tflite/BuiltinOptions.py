...
def BuiltinOptionsCreator(unionType, table):
    ...
    if unionType == BuiltinOptions().AssignVariableOptions:
        ...
        return tflite.AssignVariableOptions.AssignVariableOptionsT.InitFromBuf(table.Bytes, table.Pos)
    ...
    if unionType == BuiltinOptions().DynamicUpdateSliceOptions:
        ...
        return tflite.DynamicUpdateSliceOptions.DynamicUpdateSliceOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().UnsortedSegmentProdOptions:
        import tflite.UnsortedSegmentProdOptions
        return tflite.UnsortedSegmentProdOptions.UnsortedSegmentProdOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().UnsortedSegmentMaxOptions:
        import tflite.UnsortedSegmentMaxOptions
        return tflite.UnsortedSegmentMaxOptions.UnsortedSegmentMaxOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().UnsortedSegmentMinOptions:
        import tflite.UnsortedSegmentMinOptions
        return tflite.UnsortedSegmentMinOptions.UnsortedSegmentMinOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().UnsortedSegmentSumOptions:
        import tflite.UnsortedSegmentSumOptions
        return tflite.UnsortedSegmentSumOptions.UnsortedSegmentSumOptionsT.InitFromBuf(table.Bytes, table.Pos)
    ...
    if unionType == BuiltinOptions().BitcastOptions:
        ...
        return tflite.BitcastOptions.BitcastOptionsT.InitFromBuf(table.Bytes, table.Pos)
    return None
