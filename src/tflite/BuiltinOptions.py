...
def BuiltinOptionsCreator(unionType, table):
    ...
    if unionType == BuiltinOptions().DepthwiseConv2DOptions:
        ...
        return tflite.DepthwiseConv2DOptions.DepthwiseConv2DOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().ConcatEmbeddingsOptions:
        import tflite.ConcatEmbeddingsOptions

        return tflite.ConcatEmbeddingsOptions.ConcatEmbeddingsOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().FullyConnectedOptions:
        ...
        return tflite.FullyConnectedOptions.FullyConnectedOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().LocalResponseNormalizationOptions:
        ...
        return (
            tflite.LocalResponseNormalizationOptions.LocalResponseNormalizationOptionsT.InitFromBuf(
                table.Bytes, table.Pos
            )
        )
    ...
    if unionType == BuiltinOptions().ResizeBilinearOptions:
        ...
        return tflite.ResizeBilinearOptions.ResizeBilinearOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().EmbeddingLookupSparseOptions:
        ...
        return tflite.EmbeddingLookupSparseOptions.EmbeddingLookupSparseOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().BatchToSpaceNDOptions:
        ...
        return tflite.BatchToSpaceNDOptions.BatchToSpaceNDOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().SpaceToBatchNDOptions:
        import tflite.SpaceToBatchNDOptions

        return tflite.SpaceToBatchNDOptions.SpaceToBatchNDOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().MaximumMinimumOptions:
        ...
        return tflite.MaximumMinimumOptions.MaximumMinimumOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().BidirectionalSequenceLSTMOptions:
        ...
        return (
            tflite.BidirectionalSequenceLSTMOptions.BidirectionalSequenceLSTMOptionsT.InitFromBuf(
                table.Bytes, table.Pos
            )
        )
    if unionType == BuiltinOptions().BidirectionalSequenceRNNOptions:
        ...
        return tflite.BidirectionalSequenceRNNOptions.BidirectionalSequenceRNNOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().UnidirectionalSequenceLSTMOptions:
        ...
        return (
            tflite.UnidirectionalSequenceLSTMOptions.UnidirectionalSequenceLSTMOptionsT.InitFromBuf(
                table.Bytes, table.Pos
            )
        )
    ...
    if unionType == BuiltinOptions().ResizeNearestNeighborOptions:
        ...
        return tflite.ResizeNearestNeighborOptions.ResizeNearestNeighborOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().SquaredDifferenceOptions:
        ...
        return tflite.SquaredDifferenceOptions.SquaredDifferenceOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().ReverseSequenceOptions:
        ...
        return tflite.ReverseSequenceOptions.ReverseSequenceOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().NonMaxSuppressionV4Options:
        ...
        return tflite.NonMaxSuppressionV4Options.NonMaxSuppressionV4OptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().NonMaxSuppressionV5Options:
        import tflite.NonMaxSuppressionV5Options

        return tflite.NonMaxSuppressionV5Options.NonMaxSuppressionV5OptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().HashtableImportOptions:
        ...
        return tflite.HashtableImportOptions.HashtableImportOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    ...
    if unionType == BuiltinOptions().VarHandleOptions:
        ...
        return tflite.VarHandleOptions.VarHandleOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().ReadVariableOptions:
        import tflite.ReadVariableOptions

        return tflite.ReadVariableOptions.ReadVariableOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().AssignVariableOptions:
        import tflite.AssignVariableOptions

        return tflite.AssignVariableOptions.AssignVariableOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().RandomOptions:
        import tflite.RandomOptions

        return tflite.RandomOptions.RandomOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().BucketizeOptions:
        import tflite.BucketizeOptions

        return tflite.BucketizeOptions.BucketizeOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().GeluOptions:
        import tflite.GeluOptions

        return tflite.GeluOptions.GeluOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().DynamicUpdateSliceOptions:
        import tflite.DynamicUpdateSliceOptions

        return tflite.DynamicUpdateSliceOptions.DynamicUpdateSliceOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().UnsortedSegmentProdOptions:
        import tflite.UnsortedSegmentProdOptions

        return tflite.UnsortedSegmentProdOptions.UnsortedSegmentProdOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().UnsortedSegmentMaxOptions:
        import tflite.UnsortedSegmentMaxOptions

        return tflite.UnsortedSegmentMaxOptions.UnsortedSegmentMaxOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().UnsortedSegmentMinOptions:
        import tflite.UnsortedSegmentMinOptions

        return tflite.UnsortedSegmentMinOptions.UnsortedSegmentMinOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().UnsortedSegmentSumOptions:
        import tflite.UnsortedSegmentSumOptions

        return tflite.UnsortedSegmentSumOptions.UnsortedSegmentSumOptionsT.InitFromBuf(
            table.Bytes, table.Pos
        )
    if unionType == BuiltinOptions().ATan2Options:
        import tflite.ATan2Options

        return tflite.ATan2Options.ATan2OptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().SignOptions:
        import tflite.SignOptions

        return tflite.SignOptions.SignOptionsT.InitFromBuf(table.Bytes, table.Pos)
    return None
